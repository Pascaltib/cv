...
import { useMusicPlayback, type NavigationState } from "./music-playback-context"
          ...
          <div className="w-full flex items-end gap-3 pb-2">
            <div className="flex-shrink-0">
              {navigation.selectedAlbum?.coverUrl ? (
                <img
                  src={navigation.selectedAlbum.coverUrl}
                ...
                <div className="w-32 h-32 bg-gradient-to-br from-gray-300 to-gray-400 rounded shadow-lg border border-gray-200 flex items-center justify-center">
                  <span className="text-4xl text-gray-500/60">&#9835;</span>
                </div>
              )}
            </div>
